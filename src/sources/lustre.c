...
/* TODO: merge build_pair and build_2_pairs in a variadic function. */
static struct rbh_value_pair *
build_2_pairs(const char *key, struct rbh_value *(*part_builder)(void *),
              void *part_builder_arg, const char *key_2,
              struct rbh_value *(*part_builder_2)(void *),
                   ...
                   struct rbh_fsevent *fsevent)
{
    ...
    switch(process_step) {
        ...
        case 1:
            ...
            fsevent->xattrs = build_enrich_map_with_fid(
                fill_inode_xattrs, "lustre", record);
            if (fsevent->xattrs.pairs == NULL)
                return -1;

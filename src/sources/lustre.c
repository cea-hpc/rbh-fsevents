...
fill_callback(void *arg)
{
    ...
    enrich = rbh_sstack_push(_values, &ENRICH, sizeof(*enrich));
                   ...
                   struct rbh_fsevent *fsevent)
{
    ...
    switch(process_step) {
        case 0:
            ...
            fsevent->xattrs = build_enrich_map(fill_callback, "path");
        ...
        case 1:
            ...
            if (build_enrich_xattr_fsevent(&fsevent->xattrs,
                    ...
                    "rbh-fsevents", fill_callback("lustre")))
                return -1;

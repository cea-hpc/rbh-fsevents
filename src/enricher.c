            ...
            struct rbh_sstack *xattrs_values, struct rbh_value **_value)
{
    ...
    rc = rbh_sstack_pop(xattrs_values, PATH_MAX -
             ...
             int *fd, struct rbh_value **_value)
{
    ...
    /* Should be ENOATTR, but it is a synonym of ENODATA defined in
     * <attr/xattr.h>, so we may aswell not bother including it.
     */
